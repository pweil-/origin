...
// Generate creates the group based on policy rules.
func (s *runAsAny) Generate(pod *api.Pod) ([]int, error){
	return []int{}, nil
}

// Validate ensures that the specified values fall within the range of the strategy.
func (s *runAsAny) Validate(pod *api.Pod, groups []int) fielderrors.ValidationErrorList {
