...
func ValidatePodSecurityPolicy(scc *api.PodSecurityPolicy) fielderrors.ValidationErrorList {
	allErrs := fielderrors.ValidationErrorList{}
	allErrs = append(allErrs, validation.ValidateObjectMeta(&scc.ObjectMeta, false, ValidatePodSecurityPolicyName).Prefix("metadata")...)
