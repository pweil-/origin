...
type PodSecurityPolicyInterface interface {
	...
	Create(scc *api.PodSecurityPolicy) (*api.PodSecurityPolicy, error)
...
func (s *podSecurityPolicy) Create(scc *api.PodSecurityPolicy) (*api.PodSecurityPolicy, error) {
...
func (s *podSecurityPolicy) Update(scc *api.PodSecurityPolicy) (result *api.PodSecurityPolicy, err error) {
	result = &api.PodSecurityPolicy{}
	err = s.client.Put().
		Resource("podSecurityPolicies").
		Name(scc.Name).
